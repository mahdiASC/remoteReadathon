...
class Readathon{
        ...
        for(let i = 0; i<3; i++){
            ...
            radio_button.on("click",e=>{
                ...
                switch(i){
                    ...
                    break;
                    case 1:
                    explaintion = "<p class='scoremeaning'>This young man may be a good fit for All Star Code.</p>";
                    break;
                    case 2:
    ...
    createHoldsPopup(holds){
        ...
        for(let student of holds){
            ...
            // STUDENT INFO
            let studentID = student.fields["Unique Student ID"][0];
            let button = $(`<button class="student-held-button">Revisit Student ${studentID}</button>`)
            div.append(button);
